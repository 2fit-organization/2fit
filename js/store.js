...
// let Supplemnts_or_Equipments = document.getElementById('Supplemnts-or-Equipments');
// let weight_loss_maintain_gain = document.getElementById('weight-loss-maintain-gain');
...
// let btn = document.getElementById('Supplemnts-product-button');
middle_section.addEventListener('click', btnHandler);


function btnHandler(event) {
  if (event.target.className === 'Supplemnts-product-button' || event.target.id === 'Equipments-product-button') {
...
//////////////
// weight_loss_maintain_gain.addEventListener('click', WMGoptionHandler);

// function WMGoptionHandler(event) {
//   event.preventDefault();
//   if (event.target.value === 'Weight-loss') {

//   } else if (event.target.value === 'Gain-muscle') {

//   } else if (event.target.value === 'Maintain-weight') {
